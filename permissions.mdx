...
> Allows viewing the Network on the Dashboard. Grants access to the Dashboard and the details page. This permission is required if a user should be able to use the Web Dashboard.
